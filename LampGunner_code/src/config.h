...
#define ESP_CONF_TIMEOUT      (90U)                        // время в секундах, которое ESP будет ждать ввода SSID и пароля WiFi сети роутера в конфигурационном режиме, после его истечения ESP перезагружается
...
#define NTP_ADDRESS           ("us.pool.ntp.org")         // сервер времени
...
#define HEIGHT                (19U)                         // высота матрицы
...
#include <WiFiClient.h> //LW
#include <ESP8266mDNS.h> //LW
...
ESP8266WebServer wifiServer(ESP_HTTP_PORT);
WiFiUDP Udp;
